...
//====================================================================
const strikePrices = () => {
    let priceListItems = document.querySelectorAll(".price-list");
    for (let i = 0; i < priceListItems.length; i++) {
      if (priceListItems[i].childNodes.length > 1) {
        priceListItems[i].firstElementChild.className = "list-price strike-price";
      }
    };
};
